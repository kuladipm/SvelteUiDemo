...
<script>
  ...
  const deleteItem = (i) => {
    ...
    showDataAfterSearch.splice(i, 1);
    showDataAfterSearch = showDataAfterSearch;
  };
...
<div class="sub-container">
  ...
  <div class="sub-container1">
    ...
    <button on:click={inCompleteItem} class="inCompleteBtn">InComplete</button>
  </div>
